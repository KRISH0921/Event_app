...
GetFavoriteEvent welcomeFromMap(String str) => GetFavoriteEvent.fromMap(json.decode(str));


class GetFavoriteEvent {
  String? status;
  int? code;
  String? message;
  Favorite? favorite;
  ...
  factory GetFavoriteEvent.fromMap(Map<String, dynamic> json) => GetFavoriteEvent(
    status: json["status"],
    code: json["code"],
...
class FavoriteRecord {
  ...
  factory FavoriteRecord.fromMap(Map<String, dynamic> json) => FavoriteRecord(
    id: json["_id"],
    userId: json["userId"],
